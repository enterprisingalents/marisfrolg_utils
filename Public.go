...
func GetRedisByKey(key string, yourDate string) (list string, err error) {
...
//创建.log日志
func CreateLog(Path string, fileName string, Data string) {
	LogPath := "./Log/" + time.Now().Format(`20060102`) + "/" + Path
...
/// <returns>创建人：周智（02511）时间：2019年8月1日15:04:08</returns>
/// <returns>最后修改人：周智（02511）时间：2019年8月13日14:56:29（修改了错误提示）</returns>
